use crate::allocation::{allocate_sparse_portfolio, SparseAllocationInput};
use crate::configuration::{CopyTradeConfig, GlobalRiskConfig};
use crate::consensus::{bounded_additive_consensus, ConsensusInput};
...
mod tests {
    ...
    fn fixed_replay_vector_v1() {
        ...
        let fixture = include_str!("../../../fixtures/hl1e-replay-v1.json");
        let fixture: serde_json::Value = serde_json::from_str(fixture).unwrap();
        assert_eq!(fixture["version"], "HL1E/V1");
        assert_eq!(fixture["vectors"].as_array().unwrap().len(), 10);
        assert_eq!(
            fixture["vectors"][0]["decision_id"],
            decision.decision_id.to_hex()
        );
    }
}
