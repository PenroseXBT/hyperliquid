...
use crate::portfolio_risk::Asset;
...
pub enum LifecycleState {
    DecisionConstructed {
        decision_id: crate::decision::DecisionId,
    },
    RiskValidated {
        decision_id: crate::decision::DecisionId,
    },
...
mod tests {
    use super::*;
    use crate::decision::{DecisionId, EngineInstanceId, PlannedCloid, Side, TargetVersion};
    use std::str::FromStr;
    ...
    #[test]
    fn observer_side_transitions_are_explicit_and_idempotent() {
