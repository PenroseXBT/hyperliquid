//! Validated boundary between Hyperdash discovery snapshots and the observer.
//!
...
use copytrade_core::configuration::{
    CopyTradeConfig, TraderCandidate, VeryProfitableLayerIdentity,
};
...
impl PreparedVeryProfitableLayer {
    ...
    /// Converts fresh observer snapshots into the cohort engine's authoritative
...
fn layer_identity(
    ...
    VeryProfitableLayerIdentity {
        cohort_id: copytrade_core::cohort::VERY_PROFITABLE_COHORT_ID.into(),
    ...
    fn artifact(existing: String, new: String) -> VeryProfitableLayerArtifact {
        VeryProfitableLayerArtifact {
            ...
            membership: HyperdashMembershipSnapshot {
                schema_version: 1,
                source: copytrade_core::cohort::VERY_PROFITABLE_COHORT_URL.into(),
                cohort_id: copytrade_core::cohort::VERY_PROFITABLE_COHORT_ID.into(),
                observed_at_ms: 1_000,
                displayed_min_all_time_pnl_usd: Decimal::from(100_000),
                displayed_max_all_time_pnl_usd: Decimal::from(1_000_000),
                completeness: copytrade_core::cohort::MembershipCompleteness::Complete,
