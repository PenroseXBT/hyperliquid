use crate::decision::{EconomicAttribution, EquityReturnBucket, SettledActionAccounting};
use crate::domain::ledger::{DualLedger, PortfolioEpisode, SourceEpisode};
...
mod tests {
    ...
    fn open_mark_to_market_cannot_become_qualified_realized_profit() {
        ...
        let accounting = SettledActionAccounting {
